      ...
      <div className="login-card">
        ...
        <div className="login-logo">
          ...
          <div className="logo-text">
            <div className="logo-brand">Swing Edge</div>
            <div className="logo-tagline">Personal Trading App</div>
          </div>
        </div>
        
        {/* Welcome Message */}
        <h1 className="welcome-heading">Welcome Back</h1>
        <p className="welcome-subtitle">Secure Institutional Trading Access</p>
        ...
        <div className="login-footer">
          <p>© 2026 Swing Edge Financial. Institutional grade security. <a href="#" className="footer-link">Privacy Policy</a> | <a href="#" className="footer-link">Terms of Service</a></p>
        </div>
      </div>
